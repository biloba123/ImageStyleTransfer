...
public abstract class SolidRVBaseAdapter<T> extends RecyclerView.Adapter<com.lvqingyang.floodsdetectassistant.tool.SolidRVBaseAdapter.SolidCommonViewHolder> {
    ...
    @Override
    public com.lvqingyang.floodsdetectassistant.tool.SolidRVBaseAdapter.SolidCommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(com.lvqingyang.floodsdetectassistant.tool.SolidRVBaseAdapter.SolidCommonViewHolder holder, int position) {
